...
class PaysDropDown extends StatefulWidget {
  @override
  _PaysDropDownState createState() => _PaysDropDownState();
}

class _PaysDropDownState extends State<PaysDropDown> {
  ...
  void handleGroupValue0(int value4) {
    setState(() {
      groupValuePay = value4;
    });
  }
